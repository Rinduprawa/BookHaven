...
<div class="bg-[#161A30] min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md mx-auto p-6">
        ...
        <div class="bg-[#31304D] rounded-2xl shadow-lg p-6">
            <h2 class="text-xl font-semibold text-white mb-6 text-center">Login to Dashboard</h2>

            <!-- Error Message -->
            <?php if (session()->getFlashdata('error')): ?>
                <div id="error-message" class="bg-red-500/20 text-white p-3 mb-4 rounded">
                    <p class="text-red-400 text-sm"><?= session()->getFlashdata('error') ?></p>
                </div>
            <?php endif; ?>

            <form method="post" action="/login/process" class="space-y-4">
                <div>
